...
# http://deadbeef.git.sourceforge.net/git/gitweb.cgi?p=deadbeef/deadbeef;a=commit;h=2bb5828e58fa8c187377f8ba75f8eb73a53ed7ca
	epatch "${FILESDIR}"/ffmpeg.c.new.lavc.patch
...
# http://forum.ubuntu.org.cn/viewtopic.php?f=74&t=338938
	for LINGUA in ${LINGUAS}; do
		if use linguas_${LINGUA}; then
			epatch "${FILESDIR}"/junklib.c.gb18030.patch
		fi
	done
}
